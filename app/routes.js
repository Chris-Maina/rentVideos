...
router.get('/videos/:slug', verifyToken, videoController.getVideo);
...
router.post('/videos/:slug/genres', videoController.createVideoGenre);
router.post('/videos/:slug/directors', videoController.createVideoDirector);
